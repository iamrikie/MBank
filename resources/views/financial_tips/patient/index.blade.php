...
@section('main-content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">A list of all my appointments</h3>

            <div class="card-tools">
                <a href="{{ route('appointments.create') }}" class="btn btn-primary">
                    <i class="fas fa-plus-circle"></i> Request An Appointment
                </a>
            </div>
        </div>
        <div class="card-body">
            <table class="table table-sm">
                ...
                @foreach($appointments as $appointment)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('patient.appointments.show', ['appointment' => $appointment->id]) }}"
