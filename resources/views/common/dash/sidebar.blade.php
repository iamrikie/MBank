<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
        ...
        <span class="bold600 color-child-6">Project_</span><span class="color-child-5">imp.</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('dash/img/153537326.jpg') }}" class="img-circle elevation-2"
                     alt="User Image">
            </div>
            <div class="info">
    ...
    <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if(auth()->user()->isAdmin()  /*or auth()->user()->isDoctor()*/)
                    <li class="nav-item">
                ...
                @else
                    ...
                    <li class="nav-item">
                        <a href="{{ route('appointments.index') }}" class="nav-link fancybox-2">
                            <i class="nav-icon fas fa-file"></i>
