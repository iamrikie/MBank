    ...
    <div class="page-title page-title-contacts bg-pattern" data-bgcolor="3B4B89">
        <div class="page-title-overlay">
            <div class="container">
                ...
                <h1>CONTACT US</h1>
                <p>You can use the provided lines to reach us.</p>
        ...
        <div class="map-info" id="map-info">
            <div class="map-info-contacts">
                <div class="map-info-phone">
                    <i class="fa fa-phone"></i> <span>+254712-526-372</span>
                </div>
                <div class="map-info-mail">
                    <i class="fa fa-envelope"></i> <span><a href="mailto:info@ianno.com">info@ianno.com</a></span>
                </div>
                <div class="map-info-location">
                    <i class="flaticon-navigation-arrow"></i> <span>Nairobi Kenya</span>
                </div>
            </div>
